...
static void customPedalProfileChangeCB( uint8 paramID );
...
static customPedalProfileCBs_t simpleBLEPeripheral_customPedalProfileCBs =
{
  customPedalProfileChangeCB    // Charactersitic value change callback
};
/*********************************************************************
 * PUBLIC FUNCTIONS
 */
...
void SimpleBLEPeripheral_Init( uint8 task_id )
{
  ...
  customPedalProfile_AddService( GATT_ALL_SERVICES );  // Simple GATT Profile
#if defined FEATURE_OAD
...
static void performPeriodicTask( void )
{
  /*uint8 valueToCopy;
  uint8 stat;
  stat = customPedalProfile_GetParameter( SIMPLEPROFILE_CHAR3, &valueToCopy);

  if( stat == SUCCESS )
  {
    customPedalProfile_SetParameter( SIMPLEPROFILE_CHAR4, sizeof(uint8), &valueToCopy);
  }*/
}

/*********************************************************************
 * @fn      customPedalProfileChangeCB
 *
